            ...
            <div class="nav-menu">
                <nav class="mainmenu mobile-menu">
                    <ul>
                        ...
                        <li class="active"><a href="./myAppointments.php">My Appointments</a></li>
                ...
                <div class="col-lg-12">
                    <div class="site-text">
                        ...
                        <div class="site-breadcrumb">
                            ...
                            <span class="sb-item">Appointment</span>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <form action="#">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <label for="cars" style="color:white">Choose your Trainer:  </label>
                                                <select class="form-select form-select-lg mb-3" aria-label=".form-select-lg example" name="traineeSelected" required>
                                                    ...
                                                    <?php
                                                        ...
                                                        if($con){
                                                            ...
                                                            while($row = mysqli_fetch_assoc($result)){
                                                                echo"<option value='".$row['trainerID']."' onclick='setProgram(\'".getProgramName($con,$row['trainerID'])."\')' >".$row['trainer_fname']." ".$row['trainer_lname'] ."</option>";
                                                            }
                                                        } else {
                                                            die("Error"); 
                                                        }
                                        ...
                                        <!-- <div class="col-lg-6">
                                            <label for="cars" style="color:white">Your Training Program:  </label>
                                            <?php
                                                        // $con =mysqli_connect("localhost","root","","fitnessgymdb");
                                                        // if($con){
                                                        //     $queryGet = "SELECT programName from fitnessprogram WHERE programID=1";
                                                        //     $result = mysqli_query($con,$queryGet);
                                        ...
                                        <div class="col-lg-6">
                                            ...
                                            <input class="form-control" type="text" id="progName" placeholder="Program Name" disabled>
                                        </div>
                                        <div class="col-lg-6">
                                    ...
                                    <!--end of appoinment-->
                                        ...
                                        <div class="col-lg-12">
                                            ...
                                            <button type="submit" name="btnAppoint">Submit <i class="ti-angle-double-right"></i></button>
                                        </div>
                                    </div>
                                </form>
                            </div>

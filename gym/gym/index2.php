            ...
            <div class="single-hero-item set-bg" data-setbg="img/slider-bg-1.jpg">
                <div class="container">
                    <div class="hero-text">
                        ...
                        <a href="./appointment.php" class="primary-btn">Join Us Now</a>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <a href="./appointment.php" class="primary-btn">Join With Us</a>
                </div>
            </div>
        </div>
    </section>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="row">
                        ...
                        <div class="col-lg-6">
                            <a href="./schedule2.php" class="primary-btn">View All Schedule</a>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-lg-12">
